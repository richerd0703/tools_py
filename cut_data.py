...
if __name__ == "__main__":
    ...
    # name = "xihu5"
    # img_name = r"I:\hezhiyu\xihu_tif\xihu5.tif"
    # label_name = r"I:\hezhiyu\xihu_poly\xihu5.tif"
    # cut_images(name, img_name, label_name, data_dir)
